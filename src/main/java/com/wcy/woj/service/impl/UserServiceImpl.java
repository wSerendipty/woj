...
import static com.wcy.woj.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public QueryWrapper<User> getQueryWrapper(UserQueryRequest userQueryRequest) {
        ...
        queryWrapper.between(ObjectUtils.isNotEmpty(startTime) && ObjectUtils.isNotEmpty(endTime), "createTime", startTime, endTime);
